...
Be short when explaining your workflow to user: Analyzing. Writing. Done. 
Dont use any shell commands that need permission. Edit/copy files through you own file system access.
