...
// Each word has: spanish, english, finnish translations
...
function getWordsFromCategory(categoryKey) {
...
function getRandomWordFromCategory(categoryKey, excludeWords = []) {
