...
export interface CategoryWithKey extends CategoryConfig {
	key: string;
}
 ...
 */
export function getCategoriesByLearningOrder(): CategoryWithKey[] {
 ...
 */
export function getCategoriesByTier(tierNumber: number): CategoryWithKey[] {
	return Object.entries(CATEGORY_CONFIG)
 ...
 */
export function getCategoryMetadata(categoryKey: string): CategoryConfig | null {
	return CATEGORY_CONFIG[categoryKey] || null;
}

/**
 * Get tier emoji based on tier number
 */
